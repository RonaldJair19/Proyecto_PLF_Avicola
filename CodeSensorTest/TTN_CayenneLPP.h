...
#define LPP_GAS_TOXIC 137 // 2 bytes, 1 lux unsigned
#define LPP_GAS_FLAMABLE 138 // 2 bytes, 1 lux unsigned
...
#define LPP_LUMINOSITY_SIZE 2 // 2 bytes, 1 lux unsigned
#define LPP_GAS_TOXIC_SIZE 2 // 2 bytes, 1 lux unsigned
//#define LPP_GAS_TOXIC_SIZE 4 // 2 bytes, 1 lux unsigned
#define LPP_GAS_FLAMABLE_SIZE 2 // 2 bytes, 1 lux unsigned
//#define LPP_GAS_FLAMABLE_SIZE 4 // 2 bytes, 1 lux unsigned
#define LPP_PRESENCE_SIZE 3 // 1 byte, 1
//#define LPP_TEMPERATURE_SIZE 4 // 2 bytes, 0.1°C signed
#define LPP_TEMPERATURE_SIZE 2 // 2 bytes, 0.1°C signed
#define LPP_RELATIVE_HUMIDITY_SIZE 1 // 1 byte, 0.5% unsigned
...
public:
    ...
    uint8_t addGasToxic(uint8_t channel, uint16_t gas);
    uint8_t addGasFlamable(uint8_t channel, uint16_t gasFlamable);
